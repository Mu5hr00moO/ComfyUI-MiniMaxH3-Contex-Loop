...
from .guide_nodes import (
    NODE_CLASS_MAPPINGS as _GUIDE_NODE_CLASS_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as _GUIDE_NODE_DISPLAY_NAME_MAPPINGS,
)
...
from .full_segment_nodes import (
...
NODE_DISPLAY_NAME_MAPPINGS.update(FULL_SEGMENT_NODE_DISPLAY_NAME_MAPPINGS)
